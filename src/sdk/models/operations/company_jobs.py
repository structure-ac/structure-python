...
class CompanyJobsRequest:
    ...
    path_params: CompanyJobsPathParams = dataclasses.field()  
    query_params: CompanyJobsQueryParams = dataclasses.field()  
